      ...
      <div className="wrapper">
        <Slider breakpoints={SLIDES_RESOLUTIONS} showSwiperButtons>
          ...
          <div className="slide">
            ...
            <img draggable={false} src="https://picsum.photos/200/300?image=218" alt="" />
          </div>
          <div className="slide">
            <img draggable={false} src="https://picsum.photos/200/300?image=119" alt="" />
            <img draggable={false} src="https://picsum.photos/200/300?image=219" alt="" />
          </div>
          <div className="slide">
            <img draggable={false} src="https://picsum.photos/200/300?image=120" alt="" />
            <img draggable={false} src="https://picsum.photos/200/300?image=220" alt="" />
          </div>
          <div className="slide">
